    ...
    <SafeAreaView style={styles.container}>
      ...
      <Home.topContainer>
        <Home.Box>
          ...
          <Home.left>
          <Home.middleBox>
            <Home.middleBox>{Perference.getDashboardTotal()+'원'}</Home.middleBox >
      ...
      <Home.bottomContainer>
        <Home.bottomBox>
          <Home.bottomBoxRow>
          <Home.colorBox style={{ marginTop: wp(1),borderRadius:100,backgroundColor: "#385bff" }} />
            <View>
            ...
            <Home.colorBox style={ { marginTop: wp(1),borderRadius:100,backgroundColor: '#FFBF00' }} />
            <View>
